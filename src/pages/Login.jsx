                    ...
                    <form onSubmit={handleLogin} className="space-y-5">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                placeholder={role === 'Admin' ? "admin@careernavigator.io" : "name@example.com"}
                                required
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    required
                                />
                                <button type="button" className="absolute right-4 top-1/2 transform -translate-y-1/2 text-slate-400 hover:text-slate-600">

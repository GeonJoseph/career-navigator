...
const Navbar = () => {
    ...
    const navItems = [
        { label: 'Home', path: '/' },
        { label: 'Profile', path: '/settings' }, // Mapping Profile to Settings for now
        { label: 'Bot', path: '/chat' },
        { label: 'Results', path: '/results' }, // Placeholder
        { label: 'Courses', path: '/courses' }, // Placeholder
        { label: 'Jobs', path: '/applications' }, // Mapping Jobs to Applications
    ];
